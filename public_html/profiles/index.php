 ...
 <?php include"../header.php"; ?>
		...
		<section class="block-wrapper mt-15">
			<div class="container" style="background: #ffffff;">
				<div class="row mb-30">
					<div class="col-lg-12">
					 ...
					 <ol class="breadcrumb">
					 <?php  
					$scat="SELECT d.hindi_name AS main_name,s.*  FROM categories AS d JOIN categories AS s ON s.parent=d.id WHERE d.cat_url='$url'"	;
					$ex_scat=mysqli_query($con,$scat);
					$i=1; while($row=mysqli_fetch_array($ex_scat)) {
					 ?>
					 <?php if($i==1){ $i++;?>
						<li>
							<a href="#">
								<i class="fa fa-home"></i>
								<?php echo $row['main_name'];?>
							</a>
						</li>
						<?php } ?>
						<li>
							<a href="<?php echo $row['cat_url'];?>">
								
								<?php echo $row['hindi_name'];?>
							</a>
						</li>
						...
						<div class="" style="padding: 20px;border: 1px solid #c3c3c3;margin-top: 20px;">
							...
							<div class="clearfix entry-cat-header">
								<h2 class="ts-title float-left"><?php echo $rs['hindi_name']; ?> </h2>
          ...
          <option value="prev-next">Display Prev Next Only</option>
					...
					<div class="col-lg-9" id="pagination-result" style="border: 1px solid #c3c3c3;padding: 20px;">
					...
					<div class="col-lg-3">
						<div class="right-sidebar-1">
							...
							<div class="widgets widget-banner">
								<a href="#">
									<img class="img-fluid" src="<?php echo $urlroot; ?>images/banner/sidebar-banner4.jpg" alt="">
								</a>
							</div>
							<!-- widgets end-->
								...
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane active ts-grid-box post-tab-list" id="home">
										<div class="post-content media">
											<img class="d-flex sidebar-img" src="<?php echo $urlroot; ?>images/news/sports/sports2.jpg" alt="">
										...
										<!--post-content end-->
										<div class="post-content media ">
											<img class="d-flex sidebar-img" src="<?php echo $urlroot; ?>images/news/tech/tech4.jpg" alt="">
											<div class="media-body">
												<span class="post-tag">
										...
										<!--post-content end-->
										<div class="post-content media">
											<img class="d-flex sidebar-img" src="<?php echo $urlroot; ?>images/news/sports/sports3.jpg" alt="">
											<div class="media-body">
												<span class="post-tag">
										...
										<!--post-content end-->
										<div class="post-content media">
											<img class="d-flex sidebar-img" src="<?php echo $urlroot; ?>images/news/fashion/fashion4.jpg" alt="">
											<div class="media-body">
												<span class="post-tag">
				...
				<div class="row">
					<div class="col-lg-4">
						<div class="footer-logo">
							<a href="#">
								<img src="<?php echo $urlroot; ?>images/logo/footer_logo.png" alt="">
							</a>
						</div>
						<!-- footer logo end-->
					</div>
